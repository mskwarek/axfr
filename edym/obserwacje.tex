...
TLD .de jest jedną z tych, które wymagają zabezpieczania stref DNS przed \textit{zone enumeration}\cite{}. Okazuje się natomiast,
...
zostały przedstawione w lsitingu \ref{}. Innym wynikiem typu zachowania były odpowiedzi o liczbie linii ok. 11 tysięcy.
...
wartości około 8000 linijek w pliku strefy. Plik o około 11 tysiącach wpisów był tworzony w wyniku otrzymania rozszerzonej wiadomości
HTTP 400 -- została ona przedstawiona na listingu \ref{}.
...
protokołu -- DNSSEC\cite{RFC4034, RFC4035}. Zgodnie z tym, co zostało opisane w rozdziale \ref{}, Dla każdej pary rekordów
