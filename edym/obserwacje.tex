...
\begin{figure}[ht]
\centering
\includegraphics[width=1.0\textwidth]{image/unuserd_wireshark}
\caption{}
...
Na wykresie \ref{fig:unusedPieChart} pokazano procentowy rozkład krajów z których pochodziły serwery przestrzeni nazw. Jak widać,
...
jest .com, kojarzona w głównej mierze ze Stanami Zjednoczonymi. Pojawiają się jednak domeny
\begin{figure}[ht]
\centering
\includegraphics[width=1.0\textwidth]{image/unuserd_wireshark}
\caption{}
