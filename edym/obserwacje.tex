...
W celu określenia numerów systemów autonomicznych adresów IP pozyskanych podczas skanowania zaimplementowane zostało kolejne
...
Kolejną z wymienionych usług był serwer CI Jenkins. Jest to jeden z najpopularniejszych systemów ciągłej integracji. Filtrując
...
\section{Wpisy SPF}
Wpisy SPF (ang. \textit{Sender Policy Framework}) zostały zdefiniowane w celu ochrony użytkowników domeny przed spamem. Pozwalają na określanie reguł, czy wiadomość
