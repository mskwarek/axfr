...
\begin{center}
	\begin{figure}
	\includegraphics[scale=1]{image/exists_domain}
	\caption{Przepływ informacji podczas odpytywania o istniejącą domenę.}
	\label{fig:dns_exists_domain}
	\end{figure}
\end{center}
...
\begin{center}
	\begin{figure}
	\includegraphics[scale=1]{image/nx_domain}
	\caption{Przepływ informacji podczas odpytywania o istniejącą domenę.}
	\label{fig:dns_exists_domain}
	\end{figure}
\end{center}
