...
Istotnym typem rekordu jest również typ 250. -- rekord TSIG(ang. \textit{Secret Key Transaction Authentication for DNS}) zdefiniowany w dokumencie RFC 2845\cite{RFC2845}. Rekord TSIG pozwala na wykorzystywanie mechanizmów znanych z protokołu DNSSEC\cite{} w protokole DNS zaproponowanych w RFC 1035\cite{RFC1035}. Praktyka taka została zaproponowana z powodu częstych problemów z używaniem protokołu DNSSEC\cite{}. Wprowadzenie korzystania z rekordów TSIG pozwala między innymi na:
\begin{enumerate}
