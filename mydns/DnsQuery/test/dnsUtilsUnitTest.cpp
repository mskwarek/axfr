...
TEST(DnsUtilsTestSuite, ShouldChangeFormatWhenProperDataArePassed)
{
    unsigned char expected[25] = {
        '\x03', 'w', 'w', 'w', '\x06', 'g', 'o', 'o', 'g', 'l', 'e', '\x03', 'c', 'o', 'm'};
    unsigned char returned[25] = "";
    unsigned char passed[25] = {
...
{
    unsigned char returned[128] = "";
    unsigned char expected[25] = {'\x06', 'n', 's', 'z', 't', 'm', '1', '\x04', 'd', 'i', 'g', 'i',
        '\x05', 'n', 'i', 'n', 'j', 'a'};

    unsigned char dns_raw_soa_data[59] = {0xc0, 0x0c, 0x00, 0x06, 0x00, 0x01, 0x00, 0x00, 0x1c,
        0x20, 0x00, 0x2f, 0x06, 0x6e, 0x73, 0x7a, 0x74, 0x6d, 0x31, 0x04, 0x64, 0x69, 0x67, 0x69,
        0x05, 0x6e, 0x69, 0x6e, 0x6a, 0x61, 0x00, 0x05, 0x72, 0x6f, 0x62, 0x69, 0x6e, 0xc0, 0x34,
        0x78, 0x39, 0x9e, 0x51, 0x00, 0x02, 0xa3, 0x00, 0x00, 0x00, 0x03, 0x84, 0x00, 0x12, 0x75,
        0x00, 0x00, 0x00, 0x0e, 0x10};
